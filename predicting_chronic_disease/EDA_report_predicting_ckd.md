...
A bootstrap analysis only further solidifies this rejection of the null hypothesis by providing a 99% confidence interval of <img src="img/pairs_bs_labor.png" alt="Pairs Bootstrap Regression" width="60%" align="right" />the difference of mean assuming the null hypothesis to be between -0.065 and + 0.066, with a bootstrap sample mean difference in means of 9.62 and a z-score of 384.31, giving a p-value of virtually 0.0. This implies that low rates of labor participation can be correlated with higher rates of CKD.
